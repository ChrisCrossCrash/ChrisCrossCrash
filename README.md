...
💽 DataBase: If Django’s default SQLite isn’t enough, I set up a PostgreSQL server on AWS RDS.

🛠 Server: I prefer to use Ubuntu Server with Nginx.
...
<!--
**ChrisCrossCrash/ChrisCrossCrash** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
