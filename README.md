...
- **[Django](https://www.djangoproject.com/) with [Django REST Framework](https://www.django-rest-framework.org/)**: Back end framework (for when a database or back-end functionality is warrented)
...
- **[Three.JS](https://threejs.org/) with [React Three Fiber](https://github.com/pmndrs/react-three-fiber)**: Libraries for displaying real-time 3D grapics on the web
